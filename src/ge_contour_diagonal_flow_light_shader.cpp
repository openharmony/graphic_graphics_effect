...
std::shared_ptr<Drawing::Image>
    GEContourDiagonalFlowLightShader::MakeContourDiagonalFlowLightPrecalculationShader(Drawing::Canvas& canvas,
...
std::shared_ptr<Drawing::ShaderEffect>
    GEContourDiagonalFlowLightShader::MakeContourDiagonalFlowLightShader(const Drawing::Rect& rect)
{
    ...
    builder_->SetChild("precalculationImage", shader); // TODO: replace with real precalculation image
    ...
    builder_->SetUniform("line1Color", contourDiagonalFlowLightParams_.line1Color_[NUM_0],
        contourDiagonalFlowLightParams_.line1Color_[NUM_1], contourDiagonalFlowLightParams_.line1Color_[NUM_2]);
    ...
    builder_->SetUniform("line2Color", contourDiagonalFlowLightParams_.line2Color_[NUM_0],
