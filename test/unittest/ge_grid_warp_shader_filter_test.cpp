 ...
 * @tc.type: FUNC
 */
HWTEST_F(GEGridWarpShaderFilterTest, Constructor_005, TestSize.Level1)
{
    size_t pointsNum = GEGridWarpShaderFilter::GRID_WARP_MAIN_POINT_NUM;
    Drawing::GEGridWarpShaderFilterParams params;
    for (size_t i = 0; i < pointsNum; ++i) {
    ...
    for (size_t i = 0; i < pointsNum; ++i) {
        params.rotationAngles[i].first = -90.0f;
        params.rotationAngles[i].second = 0.0f;
    }
    ...
    std::array<Drawing::Point, GEGridWarpShaderFilter::BEZIER_WARP_POINT_NUM> bezierPatch0 = {
        Drawing::Point{0.0f, 0.0f}, Drawing::Point{0.0f, -pointsDistance},
        Drawing::Point{0.5f, pointsDistance}, Drawing::Point{0.5f, 0.0f},
        Drawing::Point{0.5f, pointsDistance}, Drawing::Point{0.5f, 0.5f - pointsDistance},
        Drawing::Point{0.5f, 0.5f}, Drawing::Point{0.5f, 0.5f + pointsDistance},
        Drawing::Point{0.0f, 0.5f - pointsDistance}, Drawing::Point{0.0f, 0.5f},
        Drawing::Point{0.0f, 0.5f - pointsDistance}, Drawing::Point{0.0f, pointsDistance}
    };
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GEGridWarpShaderFilterTest, Constructor_006, TestSize.Level1)
{
    size_t pointsNum = GEGridWarpShaderFilter::GRID_WARP_MAIN_POINT_NUM;
    Drawing::GEGridWarpShaderFilterParams params;
    for (size_t i = 0; i < pointsNum; ++i) {
    ...
    std::array<Drawing::Point, GEGridWarpShaderFilter::BEZIER_WARP_POINT_NUM> bezierPatch1 = {
        Drawing::Point{0.5f, 0.0f}, Drawing::Point{0.5f, pointsDistance},
        Drawing::Point{1.0f, -pointsDistance}, Drawing::Point{1.0f, 0.0f},
        Drawing::Point{1.0f, pointsDistance}, Drawing::Point{1.0f, 0.5f - pointsDistance},
        Drawing::Point{1.0f, 0.5f}, Drawing::Point{1.0f, 0.5f - pointsDistance},
        Drawing::Point{0.5f, 0.5f + pointsDistance}, Drawing::Point{0.5f, 0.5f},
        Drawing::Point{0.5f, 0.5f - pointsDistance}, Drawing::Point{0.5f, pointsDistance}
    };
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GEGridWarpShaderFilterTest, Constructor_007, TestSize.Level1)
{
    size_t pointsNum = GEGridWarpShaderFilter::GRID_WARP_MAIN_POINT_NUM;
    Drawing::GEGridWarpShaderFilterParams params;
    for (size_t i = 0; i < pointsNum; ++i) {
    ...
    for (size_t i = 0; i < pointsNum; ++i) {
        params.rotationAngles[i].first = 0.0f;
        params.rotationAngles[i].second = -90.0f;
    }
    ...
    std::array<Drawing::Point, GEGridWarpShaderFilter::BEZIER_WARP_POINT_NUM> bezierPatch2 = {
        Drawing::Point{0.0f, 0.5f}, Drawing::Point{pointsDistance, 0.5f},
        Drawing::Point{0.5f - pointsDistance, 0.5f}, Drawing::Point{0.5f, 0.5f},
        Drawing::Point{0.5f - pointsDistance, 0.5f}, Drawing::Point{0.5f + pointsDistance, 1.0f},
        Drawing::Point{0.5f, 1.0f}, Drawing::Point{0.5f - pointsDistance, 1.0f},
        Drawing::Point{pointsDistance, 1.0f}, Drawing::Point{0.0f, 1.0f},
        Drawing::Point{pointsDistance, 1.0f}, Drawing::Point{0.0f - pointsDistance, 0.5f}
    };
...
/**
 * @tc.name: Constructor_008
 * @tc.desc: Verify the constructor with specific ControlPoints values
 * @tc.type: FUNC
 */
HWTEST_F(GEGridWarpShaderFilterTest, Constructor_008, TestSize.Level1)
{
    size_t pointsNum = GEGridWarpShaderFilter::GRID_WARP_MAIN_POINT_NUM;
    Drawing::GEGridWarpShaderFilterParams params;
    for (size_t i = 0; i < pointsNum; ++i) {
    ...
    std::array<Drawing::Point, GEGridWarpShaderFilter::BEZIER_WARP_POINT_NUM> bezierPatch3 = {
        Drawing::Point{0.5f, 0.5f}, Drawing::Point{0.5f + pointsDistance, 0.5f},
        Drawing::Point{1.0f - pointsDistance, 0.5f}, Drawing::Point{1.0f, 0.5f},
        Drawing::Point{1.0f + pointsDistance, 0.5f}, Drawing::Point{1.0f - pointsDistance, 1.0f},
        Drawing::Point{1.0f, 1.0f}, Drawing::Point{1.0f - pointsDistance, 1.0f},
        Drawing::Point{0.5f + pointsDistance, 1.0f}, Drawing::Point{0.5f, 1.0f},
        Drawing::Point{0.5f - pointsDistance, 1.0f}, Drawing::Point{0.5f + pointsDistance, 0.5f}
    };
