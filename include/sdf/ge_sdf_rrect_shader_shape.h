...
private:
    ...
    std::shared_ptr<Drawing::RuntimeShaderBuilder> GettSDFRRectNormalShapeBuilder() const;
    ...
    std::shared_ptr<ShaderEffect> GenerateMatrixTransformShader(float width, float height,
        std::shared_ptr<ShaderEffect> shapeShader) const;
    std::shared_ptr<Drawing::RuntimeShaderBuilder> GetMatrixTransformBuilder() const;
    std::shared_ptr<ShaderEffect> GenerateMatrixTransformShaderEffect(float width, float height,
