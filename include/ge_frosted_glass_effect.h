...
public:
    ...
    ~GEFrostedGlassEffect() override = default;
...
private:
    ...
    Drawing::GEFrostedGlassEffectParams frostedGlassEffectParams_;
};

} // namespace Rosen
} // namespace OHOS

#endif // GRAPHICS_EFFECT_GE_FROSTED_GLASS_SHADER_EFFECT_H