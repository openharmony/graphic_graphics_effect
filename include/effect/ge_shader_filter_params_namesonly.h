...
/*
 * IMPORTANT NOTICE:
 * This file is leave here for backward compatibility
 * New effect types should use auto-generated symbols instead
...
constexpr char GE_MASK_WARPED_RING[] = "WarpedRingMask";
constexpr char GE_MASK_WARPED_RING_RADIUS[] = "WarpedRingMask_Radius";
constexpr char GE_MASK_WARPED_RING_BASE_HALF_WIDTH[] = "WarpedRingMask_BaseHalfWidth";
constexpr char GE_MASK_WARPED_RING_WIDTH_VARIATION[] = "WarpedRingMask_WidthVariation";
constexpr char GE_MASK_WARPED_RING_ROTATE_ANGLE[] = "WarpedRingMask_RotateAngle";
constexpr char GE_MASK_WARPED_RING_ROTATE_3D_PROGRESS[] = "WarpedRingMask_Rotate3DProgress";
constexpr char GE_MASK_WARPED_RING_NOISE_EVOLUTION[] = "WarpedRingMask_NoiseEvolution";
...
constexpr char GE_FILTER_SPIN_BLUR[] = "SpinBlur";
constexpr char GE_FILTER_SPIN_BLUR_CENTER[] = "SpinBlur_Center";
constexpr char GE_FILTER_SPIN_BLUR_ANGLE[] = "SpinBlur_Angle";
constexpr char GE_FILTER_SPIN_BLUR_SAMPLES[] = "SpinBlur_Samples";
constexpr char GE_FILTER_HALO_BLOOM[] = "HaloBloom";
constexpr char GE_FILTER_HALO_BLOOM_TINT_COLOR[] = "HaloBloom_TintColor";
constexpr char GE_FILTER_HALO_BLOOM_BLOOM_FACTOR[] = "HaloBloom_BloomFactor";
constexpr char GE_FILTER_HALO_BLOOM_GLOW_EXPOSURE[] = "HaloBloom_GlowExposure";
...
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_MASK_RADIUS[] = "SweepRefractionMask_MaskRadius";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_EDGE_THICKNESS[] = "SweepRefractionMask_EdgeThickness";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_REFRACT_AMOUNT[] = "SweepRefractionMask_RefractAmount";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_RIPPLE_WIDTH[] = "SweepRefractionMask_RippleWidth";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_SWEEP_OFFSET[] = "SweepRefractionMask_SweepOffset";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_CHROMA_DELTA[] = "SweepRefractionMask_ChromaDelta";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_SHAPE_TYPE[] = "SweepRefractionMask_ShapeType";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_CORNER_RADIUS[] = "SweepRefractionMask_CornerRadius";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_PRISM_WIDTH[] = "SweepRefractionMask_PrismWidth";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_PRISM_HEIGHT[] = "SweepRefractionMask_PrismHeight";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_SWEEP_CENTER_X[] = "SweepRefractionMask_SweepCenterX";
constexpr char GE_SHADER_SWEEP_REFRACTION_MASK_SWEEP_CENTER_Y[] = "SweepRefractionMask_SweepCenterY";
...
constexpr char GE_SHAPE_SDF_SUB_OP[] = "SDFSubOpShape";
constexpr char GE_SHAPE_SDF_SUB_OP_SHAPEX[] = "SDFSubOpShape_ShapeX";
constexpr char GE_SHAPE_SDF_SUB_OP_SHAPEY[] = "SDFSubOpShape_ShapeY";
constexpr char GE_SHAPE_SDF_SMOOTH_SUB_OP[] = "SDFSmoothSubOpShape";
constexpr char GE_SHAPE_SDF_SMOOTH_SUB_OP_SPACING[] = "SDFSmoothSubOpShape_Spacing";
constexpr char GE_SHAPE_SDF_SMOOTH_SUB_OP_SHAPEX[] = "SDFSmoothSubOpShape_ShapeX";
constexpr char GE_SHAPE_SDF_SMOOTH_SUB_OP_SHAPEY[] = "SDFSmoothSubOpShape_ShapeY";
...
constexpr char GE_SHAPE_SDF_ELLIPSE_SHAPE[] = "SDFEllipseShape";
constexpr char GE_SHAPE_SDF_ELLIPSE_SHAPE_CENTER[] = "SDFEllipseShape_Center";
constexpr char GE_SHAPE_SDF_ELLIPSE_SHAPE_WIDTH[] = "SDFEllipseShape_Width";
constexpr char GE_SHAPE_SDF_ELLIPSE_SHAPE_HEIGHT[] = "SDFEllipseShape_Height";
constexpr char GE_SHAPE_SDF_PATH_SHAPE[] = "SDFPathShape";
constexpr char GE_SHAPE_SDF_PATH_SHAPE_PATH[] = "SDFPathShape_Path";
constexpr char GE_SHAPE_SDF_PATH_SHAPE_OFFSET[] = "SDFPathShape_Offset";
constexpr char GE_SHAPE_SDF_PATH_SHAPE_SCALE[] = "SDFPathShape_Scale";
