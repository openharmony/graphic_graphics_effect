...
// // Compile-time branch identification for Transform and TransformCustomConvert
// enum class GETransformBranch : uint32_t {
//     // TransformCustomConvert branches
//     CUSTOM_CONVERT_SAME_TYPE_WITH_TRANSFORM = 1,
//     CUSTOM_CONVERT_SAME_TYPE_DIRECT_ASSIGN = 2,
//     CUSTOM_CONVERT_DIFFERENT_TYPE = 3,

//     // Transform conversion branches
//     CONVERT_HAS_CUSTOM = 10,
//     CONVERT_CAST_FROM_SAME_TYPE = 11,
//     CONVERT_CAST_FROM_SHARED_PTR = 12,
//     CONVERT_CAST_FROM_STATIC_CAST = 13,
//     NO_CONVERT_SAME_TYPE = 14,
//     UNSUPPORTED_CONVERSION = 15,

//     // Transform range constraint branches
//     RANGE_COMPONENT_WISE_MIN_MAX = 20,
//     RANGE_COMPONENT_WISE_MIN = 21,
//     RANGE_COMPONENT_WISE_MAX = 22,
//     RANGE_SCALAR_MIN_MAX = 23,
//     RANGE_SCALAR_MIN = 24,
//     RANGE_SCALAR_MAX = 25,
//     NO_RANGE = 26,
// };

// // Compile-time branch identification for TransformCustomConvert
// template<GEParamsMemberTag Tag, typename FromType, typename ToType>
// constexpr GETransformBranch GetTransformCustomConvertBranch()
// {
//     using namespace ValueTransformerTypeTraits;
//     using Constraint = GEParamsConstraintInfo<Tag>;
//     using Transformer = typename Constraint::CustomTransformer;
...
//     if constexpr (std::is_same_v<FromType, ToType>) {
//         if constexpr (has_transform_method_v<Transformer, FromType, ToType>) {
//             return GETransformBranch::CUSTOM_CONVERT_SAME_TYPE_WITH_TRANSFORM;
//         } else {
//             return GETransformBranch::CUSTOM_CONVERT_SAME_TYPE_DIRECT_ASSIGN;
//         }
//     } else {
//         return GETransformBranch::CUSTOM_CONVERT_DIFFERENT_TYPE;
//     }
// }

// // Compile-time branch identification for Transform (conversion phase)
// template<GEParamsMemberTag Tag, typename FromType, typename ToType>
// constexpr GETransformBranch GetTransformConversionBranch()
// {
//     using namespace ValueTransformerTypeTraits;
//     using Constraint = GEParamsConstraintInfo<Tag>;
...
//     if constexpr (Constraint::HAS_CONVERT) {
//         if constexpr (Constraint::HAS_CUSTOM) {
//             return GETransformBranch::CONVERT_HAS_CUSTOM;
//         } else if constexpr (std::is_same_v<FromType, ToType>) {
//             return GETransformBranch::CONVERT_CAST_FROM_SAME_TYPE;
//         } else if constexpr (is_shared_ptr_v<ToType>) {
//             return GETransformBranch::CONVERT_CAST_FROM_SHARED_PTR;
//         } else {
//             return GETransformBranch::CONVERT_CAST_FROM_STATIC_CAST;
//         }
//     } else if constexpr (std::is_same_v<FromType, ToType>) {
//         return GETransformBranch::NO_CONVERT_SAME_TYPE;
//     } else {
//         return GETransformBranch::UNSUPPORTED_CONVERSION;
//     }
// }

// // Compile-time branch identification for Transform (range constraint phase)
// template<GEParamsMemberTag Tag, typename FromType, typename ToType>
// constexpr GETransformBranch GetTransformRangeConstraintBranch()
// {
//     using Constraint = GEParamsConstraintInfo<Tag>;
...
//         if constexpr (Constraint::COMPONENT_WISE) {
//             if constexpr (Constraint::HAS_MIN && Constraint::HAS_MAX) {
//                 return GETransformBranch::RANGE_COMPONENT_WISE_MIN_MAX;
//             } else if constexpr (Constraint::HAS_MIN) {
//                 return GETransformBranch::RANGE_COMPONENT_WISE_MIN;
//             } else if constexpr (Constraint::HAS_MAX) {
//                 return GETransformBranch::RANGE_COMPONENT_WISE_MAX;
//             }
//         } else {
//             if constexpr (Constraint::HAS_MIN && Constraint::HAS_MAX) {
//                 return GETransformBranch::RANGE_SCALAR_MIN_MAX;
//             } else if constexpr (Constraint::HAS_MIN) {
//                 return GETransformBranch::RANGE_SCALAR_MIN;
//             } else if constexpr (Constraint::HAS_MAX) {
//                 return GETransformBranch::RANGE_SCALAR_MAX;
//             }
//         }
//     }
//     return GETransformBranch::NO_RANGE;
// }
